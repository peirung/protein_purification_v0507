...
class Protocol
  ...
  def main
    ...
    # Spin by the tabletop high-speed centrifuge under 24,000g for 30mins at 4°C in Prof. Baker’s Lab.
  ...
  def lyse_cell_by_sonicator(op_count,op_in_cell_pellet,op_out_cell_lysate)
    ...
    show do
        ...
        bullet "Bring the following items to MolES."
  ...
  def weigh_and_balance_tubes(op_count)
    show do
        ...
        warning "It's very important to balance tubes before using the high-speed centrifuge at Prof. Baker's lab."
    end
  end
  ...
  def spin_hs_centrifuge(op_count)
    show do
        ...
        note "Bring tubes (ID: 1 to #{op_count}) in a ice bucket to Prof. Baker's Lab (MolES, 4th Floor)."
